...
class TextCinematicGraphics {
     ...
     */
    fun setImage(a : Activity, rm : RequestManager, id : Int, onCompletion : () -> Unit) {
    ...
    companion object {
        ...
        fun setImages(a: Activity, rm : RequestManager) {
            ...
            rm.load(R.drawable.friendzoned2).apply(originalNoCachRequestOptions).into(a.findViewById(R.id.end_logo))

            rm.load(R.drawable.rate).apply(originalNoCachRequestOptions).into(a.findViewById(R.id.end_rate))
        }
        ...
        /**
         * Update social network's visibility
         * @param a : Activity
         * @param isVisible : Boolean
         */
        fun socialNetworkVisibility(a: Activity, isVisible: Boolean) {
            val visibility = if(isVisible) View.VISIBLE else View.INVISIBLE
            a.findViewById<TextView>(R.id.end_socialnetwork_profil_name).visibility = visibility
            a.findViewById<View>(R.id.end_icon_instagram).visibility = visibility
            a.findViewById<TextView>(R.id.end_socialnetwork_game_by).visibility = visibility
        }

        /**
         * Updates the social network profil's name
         * @param a : Activity
         * @param str : String
         */
        fun socialNetworkProfilName(a: Activity, str : String?) {
            a.findViewById<TextView>(R.id.end_socialnetwork_profil_name).text = str
        }
