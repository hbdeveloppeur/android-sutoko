...
public final class Chapter implements Parcelable {
    ...
    public Chapter() {
        ...
        imageId = R.color.transparent;
    }

    public Chapter(String code, String title, String description, String startingConversationName, String startingConversationStatus, boolean isConversation, int imageId) {
        this.code = code;
        this.title = title;
