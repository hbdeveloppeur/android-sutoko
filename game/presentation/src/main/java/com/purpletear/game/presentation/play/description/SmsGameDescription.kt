package com.purpletear.game.presentation.play.description
...
import com.purpletear.game.presentation.play.GameSessionViewModel
...
@Composable
internal fun SmsGameDescription(
    number: Int, 
    totalChapters: Int, 
    title: String, 
    description: String, 
