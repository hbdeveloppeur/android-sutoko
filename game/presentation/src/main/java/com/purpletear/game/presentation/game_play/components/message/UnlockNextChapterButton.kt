...
@Composable
internal fun UnlockNextChapterButton(
    modifier: Modifier = Modifier,
    text: String = stringResource(R.string.game_presentation_message_next_chapter_unlock_button),
    onClick: () -> Unit = {},
) {
    Box(
        modifier = modifier
        ...
        Image(
            painter = painterResource(R.drawable.game_presentation_button_unlock_ads_bg),
        ...
        IconComposable(
            icon = Icon.LottieAnimation(
                drawableId = R.raw.game_presentation_lottie_video_ad,
