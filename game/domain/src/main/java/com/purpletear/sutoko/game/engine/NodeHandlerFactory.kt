...
class NodeHandlerFactory @Inject constructor(
    ...
    private val stopSoundHandler: StopSoundNodeHandler,
    ...
    private val visualNovelHandler: VisualNovelNodeHandler,
) {
    /**
    ...
    fun getHandler(type: NodeType): NodeHandler = when (type) {
        ...
        NodeType.STOP_SOUND -> stopSoundHandler
        ...
        NodeType.VISUAL_NOVEL -> visualNovelHandler
    }
}
