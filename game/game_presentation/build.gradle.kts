...
android {
    namespace = "com.purpletear.game_presentation"
    compileSdk = 35
...
dependencies {
    ...
    implementation(project(":game:game_data"))
    implementation(project(":version:version_domain"))
    implementation(project(":version:version_infrastructure"))
    ...
    implementation(project(":in_app_purchase:in_app_purchase_data"))
