...
class GameRepositoryImplTest {
    ...
    private val stubGameInstallationRepository = object : GameInstallationRepository {
        override suspend fun saveInstallation(gameId: String, version: String) {}
        override suspend fun getInstallation(gameId: String): GameInstallation? = null
    ...
    fun `generateDownloadLinkInternal works with real endpoint for free game KwSEkz9VfM5`() =
        runTest {
            val repository = GameRepositoryImpl(api, stubGameInstallationRepository, stubNtfy)
