...
import com.purpletear.game.data.repository.GamePreviewSoundRepositoryImpl
...
abstract class RepositoryModule {
    ...
    @Binds
    @Singleton
    abstract fun bindGamePreviewSoundRepository(
        impl: GamePreviewSoundRepositoryImpl
